...
export default function Single() {
  ...
  async function CreateItem() {
    ...
    const metadata = await nftstorage.store({
      image: new File([image_nft.data], "panda.jpg", { type: "image/jpg" }),
      name: name_nft,
  ...
  return (
    <div className="single_main">
      ...
      {/* <Image
                  alt="close"
                  src="http://ipfs.io/bafybeigvb6bv5vttxgehmtzkdzlbzkbmswqkyzw5sj3k4t5k6ui4yfkuii/panda.jpg"
                  width="400px"
                  height="400px"
      ...
      <style jsx>
        {`
          ...
          .main_image {
            width: 100%;
            height: 500px;
            background-image: url('https://ipfs.io/ipfs/bafybeiajdopsmspomlrpaohtzo5sdnpknbolqjpde6huzrsejqmvijrcea/pinpie.jpg');
