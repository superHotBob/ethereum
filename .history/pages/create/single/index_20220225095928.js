...
export default function Single() {
  ...
  useEffect(() => {
    const nft_name = localStorage.getItem("name");
    const type = localStorage.getItem("type_nft");
    const image_nft = localStorage.getItem("nft");
    const nft_description = localStorage.getItem("description");
    setSelectedNft(image_nft);
    setTypeNtf(type);
    setName_ntf(nft_name);
    setDescription(nft_description);
    
  }, []);

  useEffect(() => {
    localStorage.setItem("nft", image_nft);
    localStorage.setItem("name", name_nft);
    localStorage.setItem("description", description);
   
  },[image_nft,name_nft,description]);
