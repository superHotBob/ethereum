...
export default function Single() {
  ...
  async function CreateItem() {
    const nftstorage = new NFTStorage({ token: `${process.env.DB_NFT_STORAGE_KEY}` });
    ...
    const Mycontract = await new Contract(contractABI.abi, process.env.DB_CONTRACT_ADDRESS);
